...
data class MovieDto(
    ...
    @SerializedName("rating") val rating: MovieRatingDto?,
    @SerializedName("poster") val poster: MoviePosterDto?,
    ...
    @SerializedName("similarMovies") val similarMovies: List<MovieDto>?,
)
