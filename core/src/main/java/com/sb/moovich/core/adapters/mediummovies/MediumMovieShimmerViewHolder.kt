...
import com.sb.moovich.core.databinding.ItemMediumMovieCardShimmerBinding

class MediumMovieShimmerViewHolder (
    private val binding: ItemMediumMovieCardShimmerBinding
    ...
    companion object {
        fun from(parent: ViewGroup): MediumMovieShimmerViewHolder {
            return MediumMovieShimmerViewHolder(
                ItemMediumMovieCardShimmerBinding.inflate(
