...
class MediumMovieInfoMapper
    @Inject
    constructor() {
        private fun mapDtoToEntity(mediumMovieInfoDto: MediumMovieInfoDto): MediumMovieInfo =
            MediumMovieInfo(
                ...
                genres =
                    mediumMovieInfoDto.genres?.map { genre ->
                        genre.name?.let { name ->
        ...
        fun mapListDtoToListEntity(mediumMovieInfoDtoList: List<MediumMovieInfoDto>) =
            mediumMovieInfoDtoList.map {
                mapDtoToEntity(it)
            }
