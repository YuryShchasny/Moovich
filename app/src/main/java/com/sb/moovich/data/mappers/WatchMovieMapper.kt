...
class WatchMovieMapper
    @Inject
    constructor() {
        fun mapDbToEntity(watchMovieDb: WatchMovieDb): MediumMovieInfo =
            MediumMovieInfo(
                id = watchMovieDb.id,
        ...
        fun mapEntityToDb(mediumMovieInfo: MediumMovieInfo): WatchMovieDb =
            WatchMovieDb(
        ...
        fun mapListDbToListEntity(watchMovieDbList: List<WatchMovieDb>) =
            watchMovieDbList.map {
                mapDbToEntity(it)
            }
    }
