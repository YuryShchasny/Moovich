...
class RecentMovieMapper
    @Inject
    constructor() {
        fun mapDbToEntity(recentMovieDb: RecentMovieDb): MediumMovieInfo =
            MediumMovieInfo(
                id = recentMovieDb.id,
        ...
        fun mapEntityToDb(mediumMovieInfo: MediumMovieInfo): RecentMovieDb =
            RecentMovieDb(
        ...
        fun mapListDbToListEntity(recentMovieDbList: List<RecentMovieDb>) =
            recentMovieDbList.map {
                mapDbToEntity(it)
            }
    }
