...
class ShortMovieItemListAdapter(private val context: Context) : ListAdapter<ShortMovieInfo, ShortMovieItemViewHolder>(
...
companion object {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShortMovieItemViewHolder {
        ...
        return ShortMovieItemViewHolder(inflater.inflate(R.layout.item_short_movie_card, parent, false))
    }


    override fun onBindViewHolder(holder: ShortMovieItemViewHolder, position: Int) {
